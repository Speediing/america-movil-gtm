  ...
  return (
    <section className="hero">
      <div className="hero-copy">
        <p className="eyebrow">América Móvil x SpaceXAI</p>
        <h1>The agents that work while your reps sell.</h1>
        <p className="hero-intro">
          Grok Bot can watch approved work, prepare drafts, and keep the seller
          in control. These are illustrative sample workflows. Every draft
          stays unsent until a person approves it.
        </p>
